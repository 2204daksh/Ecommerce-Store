        ...
        <div className="relative">
          <div className="overflow-hidden">
            <div
              ...
              style={{ transform: `translateX(-${(currentIndex / featuredProducts.length) * 100}%)` }}
            >
          ...
          <button
            ...
            className={`absolute top-1/2 -left-4 transform -translate-y-1/2 p-2 rounded-full transition-colors duration-300 ${
              currentIndex === 0 ? "bg-gray-400 cursor-not-allowed" : "bg-emerald-600 hover:bg-emerald-500"
            }`}
          >
          ...
          <button
            ...
            className={`absolute top-1/2 -right-4 transform -translate-y-1/2 p-2 rounded-full transition-colors duration-300 ${
              currentIndex + itemsPerPage >= featuredProducts.length ? "bg-gray-400 cursor-not-allowed" : "bg-emerald-600 hover:bg-emerald-500"
            }`}
          >
