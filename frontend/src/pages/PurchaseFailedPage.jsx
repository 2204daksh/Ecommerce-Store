...
const PurchaseCancelPage = () => {
    ...
    const errorMessage = error || "Your order has been cancelled. No charges have been made.";
        ...
        <div className="min-h-screen flex items-center justify-center px-4">
            ...
            >
                <div className="p-6 sm:p-8">
                    ...
                    <h1 className="text-2xl sm:text-3xl font-bold text-center text-red-500 mb-2">Purchase Failed</h1>
